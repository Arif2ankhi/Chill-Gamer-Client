...
//           <p className="text-3xl font-bold text-green-900">{review}</p>

//           <p className="text-3xl font-bold text-blue-600">{year}</p>
//           <p className="text-3xl font-bold text-blue-600">{genre}</p>
//           <p className="text-3xl font-bold text-yellow-400">Rating: {rating}</p>
//         </div>
//       </div>
//     </div>
//   );

    ...
    children: [
      {
        path: "/",
        element: <Home></Home>,
        loader: () => fetch("https://chill-gamer-server-xi.vercel.app/game")
      },
      {
        path: "/games/:_id",
      ...
      },
      {
        ...
        loader: () => fetch("https://chill-gamer-server-xi.vercel.app/reviews")
      },
      {
        path: "/addReview",
        element: (
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://chill-gamer-server-xi.vercel.app/reviews/${params.id}`)
      }
    ]
  }
]);
